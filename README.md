...
Import the four `apps/` directories as existing Mule projects in Anypoint Studio, or run all four with the isolated local runtime. The applications have not been deployed to CloudHub.
